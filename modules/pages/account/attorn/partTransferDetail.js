/**
 * @require partTransferDetail.css  
 */
var $ 			= require("zepto");
...
var partTransferDetail = {

	init: function () {
		this.ui          = {};
		this.ui.view     = $("#view");
		this.template    = artTemplate.compile(__inline("partTransferDetail.tmpl"));
	...
	getData: function () {
		...
		api.send(api.PRODUCT, "getPartTransferDetail", options, this);
	}
};

partTransferDetail.init();